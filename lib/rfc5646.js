...
// This second list is the same list as above, but with the language names localized by @Cubik65536 one by one by hand.
// This list can be used to display the language names in the language of the user.
// It is not completed yet and any language that doesn't have a localized name will be displayed in English.
const LOCALIZED_RFC5646_LANGUAGE_TAGS = {
    'af': 'Afrikaans',
    'af-ZA': 'Afrikaans (South Africa)',
    'ar': 'Arabic',
    'ar-AE': 'Arabic (U.A.E.)',
...
module.exports = {
    ...
    LOCALIZED_RFC5646_LANGUAGE_TAGS
}
